...
from pywebio.output import (put_image, put_html, put_button, put_success, put_error)
...
def next_interface():
    ...
    put_button(label='copy password', onclick=lambda: 'Hello World')
...
def generator_password():
    ...
    if length_password_input == type(str):
        put_error('You inserted symbols, but must be entering integer number from 1 to 2048')
